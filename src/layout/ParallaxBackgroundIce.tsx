...
const ParallaxBackgroundIce = () => {
    ...
    return(
        <div className={"top-0 w-full h-full absolute z-40 bg-cyan-500/80 pointer-events-none w-auto left-0 overflow-hidden flex "}>
...
export default ParallaxBackgroundIce;